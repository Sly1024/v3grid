define('v3grid/ColumnSelector', ['v3grid/Adapter'], function (Adapter) {
    ...
    ColumnSelector.prototype = {
        ...
        init: function (grid, config) {
            ...
            Adapter.addListener(grid.panel, 'keydown', this.keyPressHandler, this);
        },
...
//            if (this.popup) return this.popup;
        ...
        close: function () {
            Adapter.removeListener(this.popup, 'click', this.clickHandler, this);
